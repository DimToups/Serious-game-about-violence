...
public class ViolenceCardBuilder {
    ...
    public void generateIcon(Types type){
        Icon icon;
        switch (type){
            case VERBAL -> icon = Icon.VERBAL;
            case PSYCHOLOGICAL -> icon = Icon.PSYCHOLOGICAL;
            case ECONOMICAL -> icon = Icon.ECONOMICAL;
            case SEXUAL -> icon = Icon.SEXUAL;
            default -> icon = Icon.PHYSICAL;
        }
    ...
    public void generateBackground(Types type){
        ...
        switch (type){
            case VERBAL -> background = Background.VERBAL;
            case PSYCHOLOGICAL -> background = Background.PSYCHOLOGICAL;
            case ECONOMICAL -> background = Background.ECONOMICAL;
            case SEXUAL -> background = Background.SEXUAL;
            default -> background = Background.PHYSICAL;
        }
