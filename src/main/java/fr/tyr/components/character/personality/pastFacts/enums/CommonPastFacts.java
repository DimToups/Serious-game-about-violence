...
public enum CommonPastFacts {
    ...
    LOST_MONEY_AT_CASINO("A perdu son argent au casino", "La personne a perdu une grande partie de sa fortune à cause de jeux d'argent. Elle est toujours dépendente des jeux d'argent.",MentalStrength.WEAK),
    DEBTS("A des dettes","La personne doit beaucoup d'argent a son oncle.",MentalStrength.NORMAL)    ;
