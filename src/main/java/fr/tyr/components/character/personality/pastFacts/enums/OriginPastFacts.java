...
public enum OriginPastFacts {
    ...
    ORIGIN_RISING("Fier de sont origine", "La personne a grandi lors d'une époque tumultueuse pour les gens de son origine. Au fil du temps, il a apprit à être fier de qui il est.", MentalStrength.BOLD, null, Origin.AFRICAN, Origin.ARABIC, Origin.ASIAN),
    ;
     ...
     */
    OriginPastFacts(String title, String description, MentalStrength leaningMentalStrength, OriginThoughts overridingThoughts, Origin... concernedOrigins){
        this.title = title;
