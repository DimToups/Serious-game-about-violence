...
public enum GenderPastFacts {
    ...
    MALE_SUDDEN_DUMP("Séparation soudaine", "La personne s'est fait quitter par sa partenaire de façon assez soudaine et violente. Il exprime depuis une certaine méfiance envers les femmes", MentalStrength.NORMAL, GenderThoughts.MYSOGYNIST, Gender.UNKNOWN),
    FEMALE_SUDDEN_DUMP("Séparation soudaine", "La personne s'est fait quitter par son partenaire de façon assez soudaine et violente. Elle exprime depuis une certaine méfiance envers les hommes", MentalStrength.NORMAL, GenderThoughts.MISANDRIST, Gender.UNKNOWN),
    ...
    EXTREM_FEMINIST("Féministe extrêmiste", "", MentalStrength.BOLD, GenderThoughts.MISANDRIST, Gender.FEMALE),
    SOCIAL_OPPRESSION_ON_WOMEN("Oppression sociale sur les femmes", "La personne a grandi auprès de personnes se moquant des femmes. Blagues ou non, la personne pense de la même façon que ses pairs.", MentalStrength.NORMAL, GenderThoughts.MYSOGYNIST, Gender.UNKNOWN),
    SOCIAL_OPPRESSION_ON_MEN("Oppression sociale sur les femmes", "La personne a vécu auprès de personnes ayant jugé la majorité des hommes comme dégoûtants. La personne a gardé une mauvaise image des hommes.", MentalStrength.NORMAL, GenderThoughts.MISANDRIST, Gender.UNKNOWN),
    ;
